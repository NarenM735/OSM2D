...
public class GameService{
	...
	walls.add(new Wall(910, 757,1010, 1377));
	walls.add(new Wall(1010, 757,1375, 910));
	walls.add(new Wall(880, 134,980, 543));
	walls.add(new Wall(980, 134,1190, 294));
	walls.add(new Wall(634, 875,730, 1247));
	walls.add(new Wall(319, 875,634, 1037));
	walls.add(new Wall(196, 227,298, 389));
	walls.add(new Wall(196, 2,298, 209));
	walls.add(new Wall(138, 872,239, 1034));
	walls.add(new Wall(1990, 757,2090, 1377));
	walls.add(new Wall(1625, 757,1990, 910));
	walls.add(new Wall(2020, 134,2120, 543));
	walls.add(new Wall(1810, 134,2020, 294));
	walls.add(new Wall(2270, 875,2366, 1247));
	walls.add(new Wall(2366, 875,2681, 1037));
	walls.add(new Wall(2702, 227,2804, 389));
	walls.add(new Wall(2702, 2,2804, 209));
	walls.add(new Wall(2761, 872,2862, 1034));
